...
<div id="list-org" class="content scaffold-list" role="main">
    ...
    <g:if test="${params.mess}">
        <div class="message" role="status">${params.mess}</div>
    </g:if>
    <table>
        <thead>
        <tr>

            <th><g:message code="org.description.label" default="Org Type" /></th>
    ...
    <div class="pagination">
        <g:paginate total="${orgInstanceTotal}" action="showSearchResult" params="${params}" />
    </div>
</div>
</body>
</html>
